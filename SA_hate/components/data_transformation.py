...
from SA_hate.entity.artifact_entity import DataIngestionArtifacts, DataTransformationArtifacts
...
class DataTransformation:
    ...
    def raw_data_cleaning(self):
        try:
            ...
            raw_data = pd.read_csv(self.data_ingestion_artifacts.raw_data_file_path, index_col=0)
            ...
            raw_data.loc[raw_data[self.data_transformation_config.LABEL] == 0, self.data_transformation_config.LABEL] = 1
